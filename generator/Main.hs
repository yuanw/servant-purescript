...
fixTypesModule = do
  typeModule ^== "Scientist.WebAPI"
  t <- view haskType
  TypeInfo (_typePackage t) "Scientist.ServerTypes" (_typeName t) <$> psTypeParameters
...
mySettings :: Settings
mySettings =
  (addReaderParam "AuthToken" defaultSettings & apiModuleName .~ "Counter.WebAPI")
